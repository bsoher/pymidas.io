...
_Note. PyMIDAS has been tested mainly under Python 3.9, but work is under way to evaluate other Python 3.x versions._
...
PyMIDAS has been tested under Python 3.9. These instructions assume that you used Miniconda to install 64-bit Python as described below.
